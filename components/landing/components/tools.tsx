    ...
    <div id="tools">
      ...
      {isLoading ? (
        ...
        <div className="grid my-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {[
            {
              title: "تحلیل تخصصی انس طلا",
              desc: "تمرکز کامل روی بازار XAUUSD با بررسی ساختار قیمت و نقدینگی",
            },
            {
              title: "سناریوی ورود و خروج",
              desc: "هر سیگنال شامل نقطه ورود، حد ضرر و اهداف مشخصه",
            },
            {
              title: "مدیریت ریسک و سرمایه",
              desc: "ریسک هر معامله کنترل می‌شه تا از ضررهای سنگین جلوگیری بشه",
            },
            {
              title: "ثبت و آرشیو عملکرد",
              desc: "تمام سیگنال‌ها ذخیره می‌شن تا قابل بررسی و مقایسه باشن",
            },
          ].map((t) => (
            <ToolCard
              key={t.title}
